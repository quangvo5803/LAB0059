...
public class FileDao {
    ...
    public void findPersonInfo(ArrayList<Person> lp) {
        ...
        String pathFile = Validation.getString("Enter input file: ");
        lp = getListPerson(pathFile);
        double money = Validation.getDouble("Enter money: ");
        printListPerson(lp, money);
    }

    // allow user copy text to new file
    public void coppyNewFile() {
        String pathFileInput = Validation.getString("Enter input file: ");
        String pathFileOutput = Validation.getString("Enter output file: ");
